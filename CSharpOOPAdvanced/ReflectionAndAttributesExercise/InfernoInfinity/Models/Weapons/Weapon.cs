...
public class Weapon : IWeapon, IRareWeapon
{
    ...
    public int MinDamage
    {
        get
        {
            return this.BaseMinDamage * (int)Rarity + this.Slots.Where(g => g != null).Sum(g => g.Strength * 2 + g.Agility);
        }
    }
    ...
    public int MaxDamage
    {
        get
        {
            return this.BaseMaxDamage * (int)Rarity + this.Slots.Where(g => g != null).Sum(g => g.Strength * 3 + g.Agility * 4);
        }
    }
